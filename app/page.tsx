          ...
          <main className="container mx-auto px-4 py-16">
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Pick what you're working on</h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">Whether you're coding, designing, or just trying to get stuff done</p>
              </div>
              <ToolCategories selectedCategory={selectedCategory} onCategorySelect={setSelectedCategory} />
            </div>

            {/* Tools Grid */}
            <div className="mb-20">
              <div className="text-center mb-12">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">🛠️ Here's what we've got ({Object.keys(tools).length} tools)</h3>
                <p className="text-gray-600">Click any tool to jump right in</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                {Object.entries(tools).map(([key, tool], index) => (
                  <div key={key} className="animate-fade-in-up" style={{animationDelay: `${index * 0.1}s`}}>
                    <ToolCard
                      title={tool.title}
                      description={tool.description}
                      icon={tool.icon}
                      onClick={() => setOpenTool(key as ToolKey)}
            ...
            <div className="container mx-auto px-4 py-12">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  <a href="https://github.com/yadavnikhil03" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline transition-colors font-medium">yadavnikhil03</a>
                </p>
                ...
                <div className="flex justify-center space-x-6">
                  <a href="#" className="text-gray-500 hover:text-gray-700 transition-colors flex items-center gap-1"><Star className="w-4 h-4" /> About</a>
                  <a href="#" className="text-gray-500 hover:text-gray-700 transition-colors flex items-center gap-1"><Wand2 className="w-4 h-4" /> Feedback</a>
                  <a href="#" className="text-gray-500 hover:text-gray-700 transition-colors flex items-center gap-1"><Zap className="w-4 h-4" /> Contact</a>
                </div>
              </div>
            </div>
          </footer>
